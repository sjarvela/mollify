...
this["Ember"]["TEMPLATES"]["components/bs-modal"] = Ember.Handlebars.template(function anonymous(Handlebars, depth0, hlprs, partials, data) {
    this.compilerInfo = [4, '>= 1.0.0'];
    var helpers = this.merge(hlprs, Ember.Handlebars.helpers);
    data = data || {};
    var buffer = '',
        stack1, hashTypes, hashContexts, escapeExpression = this.escapeExpression,
    ...
    function program1(depth0, data) {
        ...
        hashTypes = {};
        hashContexts = {};
        data.buffer.push(escapeExpression(helpers.view.call(depth0, "view.body", {
            hash: {},
            contexts: [depth0],
            types: ["ID"],
    ...
    function program5(depth0, data) {
        ...
        var buffer = '',
            stack1, hashContexts, hashTypes, options;
        data.buffer.push("\n                ");
        hashContexts = {
            'content': depth0,
            'targetObjectBinding': depth0
        };
        hashTypes = {
            'content': "ID",
            'targetObjectBinding': "STRING"
        };
        options = {
            hash: {
                'content': (""),
    ...
    hashTypes = {};
    hashContexts = {};
    stack1 = helpers['if'].call(depth0, "body", {
        hash: {},
    ...
    hashTypes = {};
    hashContexts = {};
    stack1 = helpers.each.call(depth0, "footerButtons", {
        hash: {},
        inverse: self.noop,
